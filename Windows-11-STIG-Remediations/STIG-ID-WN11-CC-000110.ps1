<#
.SYNOPSIS
This PowerShell script prevents Windows 11 from printing over HTTP.
...
if ($currentValue -eq $valueData) {
    Write-Host "COMPLIANT: WN11-CC-000110"
    Write-Host "HTTP printing is disabled."
} else {
    Write-Host "NON-COMPLIANT: WN11-CC-000110"
